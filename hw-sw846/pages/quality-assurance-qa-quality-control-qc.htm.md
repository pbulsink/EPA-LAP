...
The statement that an analysis batch will have \<20 field samples
...
Section 7.6 states, "Quadruplicate analysis is required. Report both
...
Method Detection Limit (MDL) is no longer defined in Chapter One, nor is
